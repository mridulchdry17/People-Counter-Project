...
cap = cv2.VideoCapture(r'people.mp4')  # For video
...
while True:
    ...
    cv2.putText(img, f'{int(len(totalCountUp))} ', (929, 345), cv2.FONT_HERSHEY_PLAIN, 5, (139, 195, 75), 7, cv2.LINE_AA)
    cv2.putText(img, f'{int(len(totalCountDown))} ', (1191, 345), cv2.FONT_HERSHEY_PLAIN, 5, (50, 50, 230), 7, cv2.LINE_AA)
